...
const modal = createAppKit({
    ...
    metadata: {
        ...
        description: 'FairLaunch For LIST Community',
        url: window.location.href,
        icons: ['https://fairlaunch.cloud/liquidstake/list.png']
    }
});
...
const LINKSHORT = "liquidstake";
const contractAddress = "0xFD8B5D97bF2b45E98340dc174898C13C3E9161bd";
...
const DEFAULT_REFERRAL_ADDRESS = "0xFD8B5D97bF2b45E98340dc174898C13C3E9161bd";
  ...
  if (accountState.isConnected) {
    ...
    connectButton.innerHTML = `
      <span class="wallet-connected">
        <img src="list.png" class="wallet-favicon" alt="Wallet Icon">
        ${shortenedAddress}
      </span>
    `;

...
const modal = createAppKit({
    ...
    metadata: {
        ...
        icons: ['https://fairlaunch.cloud/polstaking/pps.png']
    }
});
...
const LINKSHORT = "polstaking";
const contractAddress = "0xC05c86Dd92345B90f0124a07A8b2B12819A472D6";
...
const DEFAULT_REFERRAL_ADDRESS = "0xC05c86Dd92345B90f0124a07A8b2B12819A472D6";
  ...
  if (accountState.isConnected) {
    ...
    connectButton.innerHTML = `
      <span class="wallet-connected">
        <img src="pps.png" class="wallet-favicon" alt="Wallet Icon">
        ${shortenedAddress}
      </span>
    `;

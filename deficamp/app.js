...
const LINKSHORT = "deficamp";
const contractAddress = "0xc0749438e1dddab6a92ae534850f776c449659fd";
...
const DEFAULT_REFERRAL_ADDRESS = "0xc0749438e1dddab6a92ae534850f776c449659fd";
  ...
  if (accountState.isConnected) {
    ...
    connectButton.innerHTML = `
      <span class="wallet-connected">
        <img src="sme.png" class="wallet-favicon" alt="Wallet Icon">
        ${shortenedAddress}
      </span>
    `;

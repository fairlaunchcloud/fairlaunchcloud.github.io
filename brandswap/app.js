...
const modal = createAppKit({
    ...
    metadata: {
        name: 'Fairlaunch For Community Support',
        description: 'Community Support For P2P Service',
        url: window.location.href,
        icons: ['https://fairlaunch.cloud/brandswap/bulldog.png']
    }
});
...
const LINKSHORT = "brandswap";
const contractAddress = "0x341D6e2BfD89A1FCC096E9EE64289D07B5D96733";
...
const DEFAULT_REFERRAL_ADDRESS = "0x341D6e2BfD89A1FCC096E9EE64289D07B5D96733";
  ...
  if (accountState.isConnected) {
    ...
    connectButton.innerHTML = `
      <span class="wallet-connected">
        <img src="bulldog.png" class="wallet-favicon" alt="Wallet Icon">
        ${shortenedAddress}
      </span>
    `;

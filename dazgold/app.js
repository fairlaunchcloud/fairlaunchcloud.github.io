...
const modal = createAppKit({
    ...
    metadata: {
        ...
        description: 'Fairlaunch For BitZaura Blockchain Community',
        url: window.location.href,
        icons: ['https://fairlaunch.cloud/dazgold/daz.png']
    }
});
...
const LINKSHORT = "dazgold";
const contractAddress = "0xfA23fa195cA06A3a7483C65fb0f208c4eCB67Cc9";
...
const DEFAULT_REFERRAL_ADDRESS = "0xfA23fa195cA06A3a7483C65fb0f208c4eCB67Cc9";
  ...
  if (accountState.isConnected) {
    ...
    connectButton.innerHTML = `
      <span class="wallet-connected">
        <img src="daz.png" class="wallet-favicon" alt="Wallet Icon">
        ${shortenedAddress}
      </span>
    `;

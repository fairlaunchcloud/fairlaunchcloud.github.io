...
const modal = createAppKit({
    ...
    metadata: {
        name: 'Fairlaunch For Community Development',
        description: 'Community Support For ETA Community Camp',
        url: window.location.href,
        icons: ['https://fairlaunch.cloud/extrade/eta.png']
    }
});
...
const LINKSHORT = "extrade";
const contractAddress = "0x58E3546B560053a41bDBAD313Fc0444e81Bd17c3";
...
const DEFAULT_REFERRAL_ADDRESS = "0x58E3546B560053a41bDBAD313Fc0444e81Bd17c3";
  ...
  if (accountState.isConnected) {
    ...
    connectButton.innerHTML = `
      <span class="wallet-connected">
        <img src="eta.png" class="wallet-favicon" alt="Wallet Icon">
        ${shortenedAddress}
      </span>
    `;
